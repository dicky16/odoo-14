...
class HrAppraisal(models.Model):
    ...
    pay_location = fields.Many2one('pay.location', related='employee_id.pay_location', string='Pay Location', store=True)
    pay_group = fields.Many2one('pay.group', related='employee_id.pay_group', string='Pay Group', store=True)
    pay_department = fields.Many2one('pay.department', related='employee_id.pay_department', string='Pay Department', store=True)
    employee_barcode = fields.Char(string='Old NIK', related='employee_id.barcode', store=True)
    employee_pin = fields.Char(string='NIK', related='employee_id.pin', store=True)
    ...
    score_number = fields.Integer(string='Score')
    periode2 = fields.Char(string='Masa Kerja Join', store=True, related="employee_id.periode2")
    ...
    def _compute_buttons_display(self):
        ...
        is_admin = self.env.user.user_has_groups('akm_hr_appraisal.group_hr_appraisal_manager')
